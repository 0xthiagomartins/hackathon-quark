...
from src.db.controllers import ctrl_client


CUSTOM_PROMPT = (
    "Dado as seguintes informações sobre a minha sessão de usuário: {session_data}\n"
    "Gerar um relatório detalhado intitulado 'Meus Clientes' para a empresa {business_name}. \n"
...
class ClientReportsGenerator:
    ...
    def __load_data(self) -> list[dict]:
        clients = ctrl_client.list(mode="all")
        return clients
